...
module.exports = class Files {
    ...
    static getSettings() {
        try {
            ...
            if (!settings.lastVersionCheck) {
                throw 'getSettings: lastVersionCheck not specified';
            }
    ...
    static saveUserSourceCode(sourceCode) {
        try {
            ...
            ipcRenderer.invoke(StringLiterals.NOTIFY_SOURCE_CODE_CHANGED).then();
        } catch (err) {
    ...
    static getPredefinedSourceCode() {
        let defaultSourceCodePath = null;
