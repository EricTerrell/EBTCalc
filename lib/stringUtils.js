...
module.exports = class StringUtils {
    ...
    static extractDelimitedText(value, delimiter) {
        let result = value.slice(value.indexOf(delimiter) + delimiter.length);
        result = result.slice(0, result.indexOf(delimiter));
