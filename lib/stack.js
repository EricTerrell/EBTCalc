...
module.exports = class Stack {
    constructor(valueFormatter, enableDisableFunctionButtons) {
    ...
    _addContextMenu() {
        ...
        this._stackElement.addEventListener(StringLiterals.CONTEXTMENU, (event) => {
            ...
            menu.append(new MenuItem({ label: 'Display Stack Contents', click() { that._displayStackContents(); } }));
            menu.append(new MenuItem({ type: StringLiterals.MENU_SEPARATOR }));
            menu.append(new MenuItem({ label: 'Copy Selected Item', click() { that._copySelectedItem(event.target.serializedValue.displayText); } }));
            menu.append(new MenuItem({ type: StringLiterals.MENU_SEPARATOR }));
            menu.append(new MenuItem({ label: 'Copy Entire Stack', click() { that._copyAllItems(); } }));
    ...
    _displayStackContents() {
        ...
        const contentPath = path.join(__dirname, '../display_stack.html');
